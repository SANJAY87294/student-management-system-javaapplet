...
File file;
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/StudentManagementSys/icons/6 Teacher-icon.png"))); // NOI18N
    ...
    private void SemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SemActionPerformed
        ...
        String sql="select * from exam where branch = ? and sem = ?";       
     try{
           ...
           {               
               ...
               Image image=toolkit.getImage(path+"/examimage/"+(rs.getString("image")));
    ...
    private void UploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UploadActionPerformed
        // TODO add your handling code here:
        try{
            String sql="insert into exam(branch, sem, image) values (?,?,?)";
            pst=conn.prepareStatement(sql);
            ...
            try {
                String path=new File(".").getCanonicalPath();
                FileUtils.copyFileToDirectory(file, new File(path+"/examimage"));
